            ...
            ?>  
             <tr>
                ...
                <td class="contenidotab" style="color:<? print $color; ?>">
                	...
                	<input type="text" id="advaloren_venta<? print $datosad['idbodega']; ?>" name="advaloren_venta<? print $datosad['idbodega']; ?>" class="tex2" value="<? if($datosv['advaloren_venta']=='') print $datosad['advaloren_venta']; else print $datosv['advaloren_venta']; ?>" maxlength="20" size="3" onMouseOver="return overlib('<? print $msg;?>', BELOW, BGCOLOR, '#000000', FGCOLOR, '#FFFFFF', TEXTCOLOR, '#787878' , '200');" onMouseOut="return nd();" style="color:<? print $color; ?>"/>
                    <input type="hidden" id="u_advaloren_venta<? print $datosad['idbodega']; ?>" name="u_advaloren_venta<? print $datosad['idbodega']; ?>" value="" />
                </td>
                <? if($_GET['cl']=='lcl' || $_GET['cl']=='aereo') { ?>
                    <td class="contenidotab" style="color:<? print $color; ?>">
                    	<? $msg = 'Minimo Tarifa ad-valoren/CIF compra: '.$datosad['min_advaloren'].'<br>Margen: '.$datosad['margen_min_advaloren']; ?>
                        <input type="text" id="min_advaloren<? print $datosad['idbodega']; ?>" name="min_advaloren<? print $datosad['idbodega']; ?>" class="tex2" value="<? if($datosv['min_advaloren']=='') print $datosad['min_advaloren_venta']; else print $datosv['min_advaloren']; ?>" maxlength="20" size="3" onMouseOver="return overlib('<? print $msg;?>', BELOW, BGCOLOR, '#000000', FGCOLOR, '#FFFFFF', TEXTCOLOR, '#787878' , '200');" onMouseOut="return nd();" style="color:<? print $color; ?>"/>
                        <input type="hidden" id="u_min_advaloren<? print $datosad['idbodega']; ?>" name="u_min_advaloren<? print $datosad['idbodega']; ?>" value="" />
                    </td>
                <? } ?>
                <td class="contenidotab" style="color:<? print $color; ?>">  
                	...
                	<input type="text" id="mes_fraccion_venta<? print $datosad['idbodega']; ?>" name="mes_fraccion_venta<? print $datosad['idbodega']; ?>" class="tex2" value="<? if($datosv['mes_fraccion_venta']=='') print $datosad['mes_fraccion_venta']; else print $datosv['mes_fraccion_venta']; ?>" maxlength="20" size="3" onMouseOver="return overlib('<? print $msg;?>', BELOW, BGCOLOR, '#000000', FGCOLOR, '#FFFFFF', TEXTCOLOR, '#787878' , '200');" onMouseOut="return nd();" style="color:<? print $color; ?>"/>
                    <input type="hidden" id="u_mes_fraccion_venta<? print $datosad['idbodega']; ?>" name="u_mes_fraccion_venta<? print $datosad['idbodega']; ?>" value="" />
                </td>
                
                <? if($_GET['cl']=='lcl' || $_GET['cl']=='aereo') { ?>
                <td class="contenidotab" style="color:<? print $color; ?>">
                	<? $msg = 'Minimo Tarifa por mes o fracci&oacute;n compra: '.$datosad['min_mes_fraccion'].'<br>Margen: '.$datosad['margen_min_mes_fraccion']; ?>
                	<input type="text" id="min_mes_fraccion<? print $datosad['idbodega']; ?>" name="min_mes_fraccion<? print $datosad['idbodega']; ?>" class="tex2" value="<? if($datosv['min_mes_fraccion']=='') print $datosad['min_mes_fraccion_venta']; else print $datosv['min_mes_fraccion']; ?>" maxlength="20" size="3" onMouseOver="return overlib('<? print $msg;?>', BELOW, BGCOLOR, '#000000', FGCOLOR, '#FFFFFF', TEXTCOLOR, '#787878' , '200');" onMouseOut="return nd();" style="color:<? print $color; ?>"/>
                    <input type="hidden" id="u_min_mes_fraccion<? print $datosad['idbodega']; ?>" name="u_min_mes_fraccion<? print $datosad['idbodega']; ?>" value="" />
                </td>
                <? } ?>
                ...
                <td class="contenidotab" style="color:<? print $color; ?>"> 
                	...
                	<input type="text" id="mes_fraccion_40_venta<? print $datosad['idbodega']; ?>" name="mes_fraccion_40_venta<? print $datosad['idbodega']; ?>" class="tex2" value="<? if($datosv['mes_fraccion_40_venta']=='') print $datosad['mes_fraccion_40_venta']; else print $datosv['mes_fraccion_40_venta']; ?>" maxlength="20" size="3" onMouseOver="return overlib('<? print $msg;?>', BELOW, BGCOLOR, '#000000', FGCOLOR, '#FFFFFF', TEXTCOLOR, '#787878' , '200');" onMouseOut="return nd();" style="color:<? print $color; ?>"/>
                    <input type="hidden" id="u_mes_fraccion_40_venta<? print $datosad['idbodega']; ?>" name="u_mes_fraccion_40_venta<? print $datosad['idbodega']; ?>" value="" />
                </td>
                <? } ?>
