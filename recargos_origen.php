...
<html>
	...
	function validaEnvia(form)
	{
		...
		//Valida que haya tipo de contenedor
		
		if(document.getElementById("tipo").value=="cont"){
			if(document.getElementById("tipo_cont").value==""){
				alert("Elija un tipo de contenedor");
				return false;
			}
		}	
...
<body style="background-color: transparent;">
	<form name="formulario" method="post">
		...
		<table width="100%" align="center">
			<tr>
				<td align="center" class="subtitseccion" colspan="2"><? print "REGARGOS DE ORIGEN FCL"; ?></td>
			</tr>
		</table>            
		<? if($_POST['nueRegistro'] == "si") 
		{
			...
			<!--Tabla de Ingreso y Edicion de Informacion-->
			<table width="100%" align="center">
				<tr>
				...
				<tr>    
					...
					<td>
						<select id="tipo" name="tipo" class="tex2" >
							<option value="N"> Seleccione </option>
							<option value='cont' <? if($datosmod['tipo']=='cont') print 'selected'?> >CONT</option>
				...
				<tr>     
					...
					<td>
					<input id="fecha_validez" name="fecha_validez" class="tex2" value="<? print $datosmod['fecha_validez']; ?>" maxlength="50" readonly onClick="return showCalendar('fecha_validez');">
				...
				<tr>
					...
					<td>
						...
						<select name="tipo_cont" id="tipo_cont">
							<option></option>
							<option <? echo($datosmod['tipo_cont'] =="20") ? "selected='selected'" : ""?> >20</option>
							<option <? echo($datosmod['tipo_cont'] =="40") ? "selected='selected'" : ""?> >40</option>
							<option <? echo($datosmod['tipo_cont'] =="40hq") ? "selected='selected'" : ""?> >40hq</option>
						</select>
					</td>
			...
			<!--Finaliza Tabla de Ingreso y Edicion de Informacion-->
			<br>
		<?
		}	
		?>
			...
			<tr>
				...
				<td>
					<select id="filtro3" name="filtro3" class="tex2" >
						...
						<option value='cont' <? if($_GET['filtro3']=='cont') print 'selected'?> >CONT</option>
					</select>
				</td>
			</tr>
			<tr> 
			  ...
			  <td>
				<input id="filtro5" name="filtro5" class="tex2" value="<? print $_GET['filtro5']; ?>" maxlength="50" readonly onClick="return showCalendar('filtro5');"></td>
				<td class="contenidotab">Fecha validez fin</td>    
			  <td>
				<input id="filtro6" name="filtro6" class="tex2" value="<? print $_GET['filtro6']; ?>" maxlength="50" readonly onClick="return showCalendar('filtro6');"></td>   
			</tr>
			<tr>	
		...
		<table width="100%"> 
			<tr>
				...
				<?
				$sqlad="select * from recargos_origen where clasificacion='fcl'";
				$sqlad .= " and estado='1'";
		...
		<!--Termina Tabla Principal de Registros--->
		...
		<!--Inicia Paginacion-->
		<table width="40%" cellpadding="0" cellspacing="10"  align="center">
			<tr>
				<td colspan="5" class="tittabla"><img src="images/ico_paginas.gif" alt="a" width="15" height="12" align="absmiddle"> Paginaci&oacute;n</td>
			</tr>
			<tr>
				<td class="botonesadmin">
					<a href="#" onClick="document.location='<?php print $_SERVER['PHP_SELF']; ?>?pag=1';"> &lt;&lt;</a>
				</td>
				<td class="botonesadmin"><a href="#" <?php if ($pag != 1) { ?> onClick="document.location='<?php print $_SERVER['PHP_SELF']; ?>?pag=<?php print ($pag - 1); ?>'" style="cursor:pointer;"<?php } ?>>&lt;</a></td>
				<td align="center">
				...
				<td class="botonesadmin"> <a href="#" <?php if ($pag != $totpag) { ?> onClick="document.location='<?php print $_SERVER['PHP_SELF']; ?>?pag=<?php print ($pag + 1); ?>';" style="cursor:pointer;"<?php } ?>> &gt;</a></td>
				<td class="botonesadmin"> <a href="#" onClick="document.location='<?php print $_SERVER['PHP_SELF']; ?>?pag=<?php print $totpag; ?>';"> &gt;&gt;</a></td>
			</tr>
		</table>
		<!--Termina Paginacion-->
