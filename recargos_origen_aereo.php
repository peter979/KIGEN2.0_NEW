...
if($_POST['datosok']=='si')
{
	...
	{
		$queryins="INSERT INTO $tabla (idagente, nombre, clasificacion, tipo, valor, minimo, moneda, fecha_validez, observaciones, margen, margen_minimo, valor_venta, minimo_venta) VALUES ('$_POST[idagente]', UCASE('$_POST[nombre]'), 'aereo', '$_POST[tipo]', UCASE('$_POST[valor]'), '$_POST[minimo]', UCASE('$_POST[moneda]'), UCASE('$_POST[fecha_validez]'), UCASE('$_POST[observaciones]'), '$_POST[margen]', '$_POST[margen_minimo]', '$_POST[valor_venta]', '$_POST[minimo_venta]')";
		//print $queryins.'<br>';
	...
	{
		$queryins = "UPDATE $tabla SET idagente='$_POST[idagente]', nombre=UCASE('$_POST[nombre]'), tipo='$_POST[tipo]', valor=UCASE('$_POST[valor]'), minimo='$_POST[minimo]', moneda=UCASE('$_POST[moneda]'), fecha_validez=UCASE('$_POST[fecha_validez]'), observaciones=UCASE('$_POST[observaciones]'), margen='$_POST[margen]', margen_minimo='$_POST[margen_minimo]', valor_venta='$_POST[valor_venta]', minimo_venta='$_POST[minimo_venta]' WHERE $llave='$_POST[idrecargo_origen]'";
		//print $queryins.'<br>';
		$buscarins=mysqli_query($link,$queryins);
...
<table width="100%" align="center">
    <tr>
    	<td align="center" class="subtitseccion" colspan="2"><? print "REGARGOS DE ORIGEN AEREO"; ?></td>
    </tr>
</table>            
...
<table width="90%" align="center">
    ...
    <tr> 
        ...
        <td>
        <input id="filtro5" name="filtro5" class="tex2" value="<? print $_GET['filtro5']; ?>" maxlength="50" readonly>
        <input class="botonesadmin" style="color:#FFFFFF;" onClick="return showCalendar('filtro5');" type='reset' value='Calendario' name='reset' />
        </td>
        <td class="contenidotab">Fecha validez fin</td>    
        <td>
        <input id="filtro6" name="filtro6" class="tex2" value="<? print $_GET['filtro6']; ?>" maxlength="50" readonly>
        <input class="botonesadmin" style="color:#FFFFFF;" onClick="return showCalendar('filtro6');" type='reset' value='Calendario' name='reset' />
        </td>   
    </tr>
    <tr>	
...
<table width="100%"> 
    <tr>
        ...
        <?
		$sqlad="select * from recargos_origen where clasificacion='aereo'";
		$sqlad .= " and estado='1'";
