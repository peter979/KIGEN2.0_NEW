<?
	...
	$tabla = "recargos_local_cliente";
	$llave = "idrecargo_local_cliente";
...
function validaEnvia(form)
{
	...
	//alert('valor' + form.valor.value + 'margen' + form.margen.value + ': ' + form.valor_venta.value);
...
if($_POST['datosok']=='si')
{
	...
	{
		$queryins="INSERT INTO $tabla (idcliente, nombre, clasificacion, tipo, valor, valor_venta, moneda, minimo, minimo_venta, fecha_validez, margen, margen_minimo, observaciones) VALUES ('$_POST[idcliente]', UCASE('$_POST[nombre]'), '$_GET[cl]', '$_POST[tipo]', '$_POST[valor]', '$_POST[valor_venta]', UCASE('$_POST[moneda]'), '$_POST[minimo]', '$_POST[minimo_venta]', UCASE('$_POST[fecha_validez]'), '$_POST[margen]', '$_POST[margen_minimo]', UCASE('$_POST[observaciones]'))";
		//print $queryins.'<br>';
...
<?
	...
	if(isset($_POST['xyz']) and $_POST['xyz']!="")
	{
		...
		else
		{
			...
			{
				$row = mysqli_fetch_array($query);
				print ("<script>document.location.href='".$_SERVER['PHP_SELF']."?idrecargo_local_cliente=$row[idrecargo_local_cliente]'</script>");
			}
			?>
			<table width="50%"align="center">
				<tr align="center">
					<td valign="top">
						...
						{
							print "<a href=".$_SERVER['PHP_SELF']."?idrecargo_local_cliente=$row[idrecargo_local_cliente]>$row[num_contrato]</a><br>";
						}
						?>
...
<? if($_POST['nueRegistro'] == "si") 
{
    ...
    <input name="idrecargo_local_cliente" type="hidden" value="<? print $datosmod['idrecargo_local_cliente'] ?>" />
	<table width="100%" align="center">
    	<tr>
            ...
            <td><input id="nombre" name="nombre" class="tex2" value="<? print $datosmod['nombre']; ?>" maxlength="50" ></td> 
          ...
          <td class="contenidotab">Tipo*</td>    
            ...
            <td>
                ...
                <input type="hidden" id="valor_venta" name="valor_venta" >            </td>
        ...
        <tr>   
            ...
            <td>
                ...
                <input type="hidden" id="minimo_venta" name="minimo_venta" >            </td>
            ...
            <input class="botonesadmin" style="color:#FFFFFF;" onClick="return showCalendar('fecha_validez');" type='reset' value='Calendario' name='reset' />            </td>   
            <td class="contenidotab">Margen</td> 
            <td>
            	<input id="margen" name="margen" class="tex2" value="<? print $datosmod['margen']; ?>" maxlength="50" >            </td>
            <td class="contenidotab">Margen Minimo</td> 
            <td>
            	<input id="margen_minimo" name="margen_minimo" class="tex2" value="<? print $datosmod['margen_minimo']; ?>" maxlength="50" >            </td>
    
            <td class="contenidotab">Observaciones</td> 
            <td><textarea name="observaciones" id="observaciones" class="tex1"  cols="40" rows="3"><? if($_POST['observaciones']!='') print $_POST['observaciones']; else print $datosmod['observaciones']; ?></textarea>            </td>                        
        <tr>
        	<td>
            	<table>
                	<tr>
...
<table width="100%"> 
    <tr>
        ...
        <?
		$sqlad="select * from recargos_local_cliente where clasificacion='$_GET[cl]' and idcliente='$_GET[idcliente]'";
		$sqlad .= " and estado='1'";
		//print $sqlad;
        ...
        for($i=0;$i<$cantpag;$i++)
        {
            ...
            ?>  
             <tr>                   
                <td class="contenidotab"><input name="registroSel" type="radio" value="<? print $datosad['idrecargo_local_cliente']; ?>" onClick="modificarRegistro(<?php print $i;?>)" ></td>
                <td class="contenidotab"><input name="eliSel" type="checkbox" onClick="" value="<? print $datosad['idrecargo_local_cliente']; ?>" /></td>
